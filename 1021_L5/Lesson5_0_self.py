...
class Window(ThemedTk):
    def __init__(self,*args,**kwargs):
        ...
        btn1 = ttk.Button(topFrame,text="按鈕1",style="fontmid.TButton", command=self.b1)
        btn1.pack(side='left',expand=True,fill='x',padx=10)
        btn2 = ttk.Button(topFrame,text="按鈕2",style="fontmid.TButton", command=self.b2)
        btn2.pack(side='left',expand=True,fill='x')
        btn3 = ttk.Button(topFrame,text="按鈕3",style="fontmid.TButton", command=self.b3)
